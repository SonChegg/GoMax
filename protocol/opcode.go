...
// Opcode identifies the request/event kind of a Max protocol frame, a port
// of pymax's protocol.enums.Opcode.
type Opcode int
...
const (
	...
	OpcodeStoriesGetStats              Opcode = 211
	OpcodeStoriesGetDetailedStats      Opcode = 212
	OpcodeStoriesReact                 Opcode = 213
	OpcodeStoriesMark                  Opcode = 214
	OpcodeStoriesSend                  Opcode = 215
	OpcodeNotifStoriesUpdate           Opcode = 216
	OpcodeStoriesEdit                  Opcode = 217
	OpcodeStoriesDelete                Opcode = 218
	OpcodeStoriesGetByStoryID          Opcode = 220
